...
/home/markus/work/install/bin/verilator --trace-fst -cc +1364-2005ext+v --top-module core_top core/spram.v core/sprom.v core/core_top.v core/core_bridge_cmd.v apf/common.v core/myc64/rtl/myc64/*.v core/myc64/rtl/myc64/cpu-tv65/rtl/*.v -Icore/myc64/rtl/myc64/cpu-tv65/rtl/ core/picorv32.v -Wno-fatal \
